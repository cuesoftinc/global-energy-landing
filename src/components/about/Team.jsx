        ...
        <div className="flex flex-col justify-start gap-5">
            ...
            <div className="px-[60px] md:px-[40px] sm:px-[20px] flex flex-row md:grid md:grid-cols-2 sm:flex sm:flex-col gap-[20px] justify-between">
                <div className="flex flex-col justify-start items-center gap-[16px]">
                    <img className="w-[350px] h-[250px] rounded-[8px] md:w-[283px] md:h-[200px]" src={team1} alt="" />
                ...
                <div className="flex flex-col justify-start items-center gap-[16px]">
                    <img className="w-[350px] h-[250px] rounded-[8px] md:w-[283px] md:h-[200px]" src={team2} alt="" />
                    <div className="flex flex-col justify-center items-center gap-[8px]">
                ...
                <div className="flex flex-col justify-start items-center gap-[16px]">
                    <img className="w-[350px] h-[250px] rounded-[8px] md:w-[283px] md:h-[200px]" src={team3} alt="" />
                    <div className="flex flex-col justify-center items-center gap-[8px]">
