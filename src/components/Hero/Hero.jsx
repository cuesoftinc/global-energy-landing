...
const Hero = () => {
    return (
        <div>
            <div className="z-[-10] h-[100vh] absolute max-w-[1600px] md:hidden"></div>
            <div>
                <div>
                    <Glow />
                </div>
                <div className="flex flex-col justify-center pt-[100px] items-center gap-5 md:w-full">
                    <div className="sm:px-[24px] md:px-[40px] flex flex-col justify-start items-center gap-[12px]">
                        <p className="text-[50px] text-center md:text-[34px] sm:text-[20px] font-semibold sm:font-bold text-black-500 leading-[70px] sm:leading-8">Welcome to the <span className="text-green">NetZero 50</span> App</p>
                    ...
                    <div className="w-full py-4 flex flex-row justify-center mt-2 items-center gap-6 sm:gap-3 z-20">
                        <Button
                            withIcon={false}
                            type="fill"
