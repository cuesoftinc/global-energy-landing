    ...
    return (
        <div className="bg-[#e3e6ef] rounded-[36px] md:rounded-[12px] px-[58px] pt-[40px] md:py-[30px] sm:px-[24px] flex flex-col gap-[30px]">
            <div className="flex flex-row justify-between">
                <p className="text-[32px] text-[#0E1C4D] font-semibold leading-[64px] w-[70%] md:w-full md:leading-[44px] sm:leading-[28px] md:text-[34px] sm:text-[20px] md:text-center">Incentives for Corporate members:</p>
                <a href="#">
                ...
                <div className="w-full flex flex-col justify-between items-start md:items-center gap-9">
                    ...
                    <div className="flex flex-row md:flex-col md:items-center items-start gap-5">
                        ...
                        <div>
                            ...
                            <p className="text-text text-[18px]  md:text-center sm:text-[14px] md:text-[16px]">Engage in meaningful sustainability tasks tailored to Corporate account type.</p>
                        </div>
                    </div>
